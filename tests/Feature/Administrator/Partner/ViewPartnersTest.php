...
namespace Tests\Feature\Administrator\Partner;

use Illuminate\Foundation\Testing\RefreshDatabase;
use Illuminate\Foundation\Testing\WithFaker;
use Tests\TestCase;

class ViewPartnersTest extends TestCase
{
    ...
    public function test_viewing()
    {
        ...
        $reqData = str_replace('"message_id":MESSAGE_ID', '"message_id":' . $message_id, '{"update_id":794738529,"callback_query":{"id":"406585492721546143","from":{"id":94665561,"is_bot":false,"first_name":"Murod","last_name":"Parmonov","username":"parmonov98","language_code":"en"},"message":{"message_id":MESSAGE_ID,"from":{"id":5010992967,"is_bot":true,"first_name":"ZumdaDevBot2","username":"Zumda2DevBot"},"chat":{"id":94665561,"first_name":"Murod","last_name":"Parmonov","username":"parmonov98","type":"private"},"date":1672284970,"text":"Tizimdagi foydalanuvchilar bilan ishlash!","reply_markup":{"inline_keyboard":[[{"text":"Operatorlar","callback_data":"operators"}],[{"text":"Haydovchilar","callback_data":"drivers"}],[{"text":"Partnyor(restoran egasi)","callback_data":"partners"}],[{"text":"Partnyor operator","callback_data":"partner_operators"}],[{"text":"Yangi foydalanuvchi \u2795","callback_data":"add_new_user"}]]}},"chat_instance":"5724290121642304888","data":"operators"}}');
        $response = $this->withHeaders([
            'Accept' => 'json/application'
        ])->postJson(
            route('webhook'),
