...
class CreatePartnerOperatorTest extends TestCase
{
    ...
    public function test_creating_choose_role()
    {
        ...
        $reqData = str_replace('"message_id":MESSAGE_ID', '"message_id":' . $message_id, '{"update_id":794738539,"callback_query":{"id":"406585492681487362","from":{"id":94665561,"is_bot":false,"first_name":"Murod","last_name":"Parmonov","username":"parmonov98","language_code":"en"},"message":{"message_id":MESSAGE_ID,"from":{"id":5010992967,"is_bot":true,"first_name":"ZumdaDevBot2","username":"Zumda2DevBot"},"chat":{"id":94665561,"first_name":"Murod","last_name":"Parmonov","username":"parmonov98","type":"private"},"date":1672454113,"edit_date":1672454113,"text":"Yangi xodimning rolini tanlang:","reply_markup":{"inline_keyboard":[[{"text":"Operator","callback_data":"choose_operator"}],[{"text":"Haydovchi","callback_data":"choose_driver"}],[{"text":"Restoran xodimi","callback_data":"choose_partner"}],[{"text":"Ortga","callback_data":"back_to_users"}]]}},"chat_instance":"5724290121642304888","data":"choose_partner_operator"}}');
        $response = $this->withHeaders([
            'Accept' => 'json/application'
        ])->postJson(
            route('webhook'),
